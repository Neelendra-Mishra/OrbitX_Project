...
# Apply nest_asyncio to allow synchronous agent functions to call async MCP helpers inside FastAPI.
import nest_asyncio
...
app = FastAPI(
    title="OrbitX",
    description=(
        "Autonomous Multi-Agent Travel Intelligence with LangGraph, MCP, "
