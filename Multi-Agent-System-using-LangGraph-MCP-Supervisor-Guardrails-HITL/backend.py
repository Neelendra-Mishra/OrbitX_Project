...
# =========================
# State - TravelState TypedDict schema
# =========================
...
"""
    ...
    # break the travel-planning workflow.
    try:
    ...
    if not allowed:
        reason = guardrail_reason or (
            "OrbitX can only help with travel-planning requests. "
...
"""
    ...
    try:
        ...
        # Full workflow behavior is preserved as the fallback.
